...
# robyn_directory <- "E:\\Downloads\\aryma\\main\\calibration_and_validation\\Robyn Things"
...
OutputModels <- robyn_run(
  ...
  iterations = 4000, # 2000 recommended for the dummy dataset with no calibration
...
OutputCollect <- robyn_outputs(
  ...
  plot_folder = "E://", # path for plots exports and files creation
...
typeof(dt_simulated_weekly)
simulated_data <- as.data.frame(dt_simulated_weekly)
# write.csv(simulated_data, file = "E://Downloads//aryma//main//calibration_and_validation//Robyn Thnigs//simulated_data.csv", row.names = FALSE)
################################################################
#### Step 4: Select and save the any model

## Compare all model one-pagers and select one that mostly reflects your business reality
print(OutputCollect)
select_model <- "5_277_6" # Pick one of the models from OutputCollect to proceed
